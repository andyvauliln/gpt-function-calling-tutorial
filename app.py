...
table = Table(airtable_api_key, "appUPfxCrNOydXoJ2", "tbl5ihe8hBVuUq28n")
...
user_query = "What is the biggest stock biggest movements today and what can cause the price movements. Pleas add a record to Airtable with the stock ticker price move and news summary"
